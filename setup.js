...
const FIELD_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "repeatLowYieldCooldownEnabled", label: "Repeat low-yield cooldown? (true/false)", type: "boolean" },
      { key: "repeatLowYieldCooldownTriggerCount", label: "Repeat low-yield cooldown trigger count", type: "number", min: 1 },
      { key: "repeatLowYieldCooldownLookbackHours", label: "Repeat low-yield cooldown lookback hours", type: "number", min: 0 },
      { key: "repeatLowYieldCooldownHours", label: "Repeat low-yield cooldown hours", type: "number", min: 0 },
      { key: "repeatLowYieldCooldownScope", label: "Repeat low-yield cooldown scope (pool/token/both)", type: "string" },
