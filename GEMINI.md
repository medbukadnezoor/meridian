...
## Start Here
- Read [CHANGELOG.md](CHANGELOG.md) first for release-by-release context.
- Review the current Darwin logic in [signal-weights.js](signal-weights.js) and [tools/screening.js](tools/screening.js).

## Current Operational Context
[CONFIRMED] Bot Version: **v1.0.9** (Enabled solMode + TP 4% on 2026-04-13)
[CONFIRMED] Bot Host: VPS **ohox** (TencentCloud Singapore, <VPS_IP>) under PM2.
...
*For current working context and handoff, read [.ai/handoffs/NEXT_STEP.md](.ai/handoffs/NEXT_STEP.md), [.ai/context/PROJECT_STATE.md](.ai/context/PROJECT_STATE.md), and [.ai/prompts/CURRENT_TASK.md](.ai/prompts/CURRENT_TASK.md). `docs/continuity/*` is legacy/reference-only for now. Mirror files are derived from `AGENTS.md`; do not edit mirror files directly.*
