...
DRY_RUN=true
DEEPSEEK_API_KEY=<if using the example DeepSeek route>
...
OKX_SECRET_KEY=<optional>
OKX_PASSPHRASE=<optional>
OKX_PROJECT_ID=<optional>
GMGN_API_KEY=<optional>
PUBLIC_API_KEY=<optional Agent Meridian relay key>
AGENT_MERIDIAN_API_URL=<optional Agent Meridian relay URL>
HIVEMIND_API_KEY=<optional>
```
